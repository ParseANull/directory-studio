...
public interface IScimAdapterFactory
{
    ...
    ScimVersion[] getSupportedVersions();

    ProviderCapabilityProfile getDefaultProfile();

    List<ScimSchema> getBundledSchemas();

    IScimAdapter create( IScimConnectionParameters params );
