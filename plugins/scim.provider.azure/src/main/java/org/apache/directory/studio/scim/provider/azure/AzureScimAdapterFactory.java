 ...
 *
 */
package org.apache.directory.studio.scim.provider.azure;
...
public class AzureScimAdapterFactory implements IScimAdapterFactory
{
    ...
    {
        return new AzureScim2Adapter( params );
    }
