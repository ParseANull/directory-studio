 ...
 *
 */
package org.apache.directory.studio.scim.provider.okta;
...
public class OktaScimAdapterFactory implements IScimAdapterFactory
{
    ...
    {
        return new OktaScim2Adapter( params );
    }
