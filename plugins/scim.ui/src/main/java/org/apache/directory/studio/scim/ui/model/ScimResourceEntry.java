...
public class ScimResourceEntry implements IEntry
{
    private static final long serialVersionUID = 1L;

    private final ScimBrowserConnection browserConnection;
    private final ScimResourceTypeEntry parent;
    ...
    public ScimResourceEntry( ScimBrowserConnection browserConnection, ScimResourceTypeEntry parent,
    ...
    public Dn getDn()
    {
        try
        {
            return new Dn( "id=" + resource.getId() + ",resourceType=" + parent.getResourceType().getName() );
        }
